...
pickled_vector = pickle.load(open('tfidf_lemma.pkl', 'rb'))
pickled_model = pickle.load(open('DecisionTreeClassifier82.pkl', 'rb'))
image_icon = Image.open('temp/icon.png')
...
if choice == 'Home':
    ...
    st.markdown('This app generate text using Machine Learning Decision Tree Classifier algorithm. You can find the code on [GitHub](https://github.com/bastianarmananta/sentiment-jhonny-amber).')
    ...
    predict_button = st.button('Generate Text', type='primary')
    st.markdown("---")
